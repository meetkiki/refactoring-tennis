...
public class TennisTest {
    ...
    public static Collection<Object[]> getAllScores() {
        return Arrays.asList(new Object[][]{
                ...
                {6, 4,"player3", "player4","Win for player3"},
                {4, 6,"player3", "player4","Win for player4"},
                {16, 14, "player5", "player6", "Win for player5"},
                {14, 16, "player5", "player6", "Win for player6"},
        });
    }
    ...
    public void checkAllScoresTennisGame2() {
        TennisGame2 game = new TennisGame2(player1Name, player2Name);
        checkAllScores(game);
    }

    @Test
    public void checkAllScoresTennisGame3() {
        TennisGame3 game = new TennisGame3(player1Name, player2Name);
        checkAllScores(game);
    }
